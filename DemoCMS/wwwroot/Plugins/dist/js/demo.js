  ...
  var $sidebar_collapsed_checkbox = $('<input />', {
    ...
    if ($(this).is(':checked')) {
      $('body').addClass('sidebar-collapse')
        ...
        $("#menu-icon").removeClass("fa-angle-double-left")
        $("#menu-icon").addClass("fa-angle-double-right")
    } else {
      $('body').removeClass('sidebar-collapse')
        $(window).trigger('resize')
        $("#menu-icon").removeClass("fa-angle-double-right")
        $("#menu-icon").addClass("fa-angle-double-left")
    }
  })
